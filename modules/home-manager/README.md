...
2. Home Manager создаёт symlinks:
...
3. **Явный контроль** - вы выбираете какие skills устанавливать
4. **Полностью воспроизводимо** - одинаковый hash = одинаковые файлы на всех машинах
5. **Нет императивных команд** - всё через Nix деривации
...
3. **Installed skills** (в порядке списка `skills`)
