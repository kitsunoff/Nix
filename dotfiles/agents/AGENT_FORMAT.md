...
2. **Обратная совместимость** - старые агенты продолжают работать
3. **Гибкость** - можно добавлять специфичные для инструмента поля
4. **Простота** - минимальный формат очень простой
5. **Мощность** - расширенный формат даёт полный контроль
